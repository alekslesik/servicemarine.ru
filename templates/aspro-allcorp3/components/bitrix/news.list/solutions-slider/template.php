									...
									<div class="line-block__item catalog-block__info-bottom--margined catalog-block__info-btn ">
										<div class="js-replace-btns js-config-btns" data-btn-config="{&quot;BASKET_URL&quot;:&quot;&quot;,&quot;BASKET&quot;:false,&quot;ORDER_BTN&quot;:true,&quot;BTN_CLASS_MORE&quot;:&quot;bg-theme-target border-theme-target&quot;,&quot;SHOW_COUNTER&quot;:false}">
											<span class="buy_block btn-actions__inner">
												<span class="buttons">
													<span class="btn btn-default btn-md btn-transparent-border bg-theme-target border-theme-target animate-load" data-event="jqm" data-param-id="3" data-autoload-product="LookOut Pro " data-autoload-service="LookOut Pro " data-autoload-project="LookOut Pro " data-autoload-news="LookOut Pro " data-autoload-sale="LookOut Pro " data-name="order_product_742">Заказать</span>
												</span>
											</span>
										</div>
									</div>
